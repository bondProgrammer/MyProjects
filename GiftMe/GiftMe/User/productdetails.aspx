<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="productdetails.aspx.cs" Inherits="User_productdetails" %>
                        ...
                        <ItemTemplate>
                            <div class="product-go">
                                <div class=" fashion-grid">
                                    <img class="img-responsive " src='<%# Eval("ImagePathf") %>' alt="">
                                </div>
                                <div class=" fashion-grid1">
                                    <h6 class="best2"><%# Eval("ItemNamef") %> </h6>
                                    <span class=" price-in1">Rs. <%# Eval("ItemPricef") %></span>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </ItemTemplate>
