<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="products.aspx.cs" Inherits="User_products" %>
                        ...
                        <ItemTemplate>
                            <div class="col-md-4 col-md4">
                                <div class="col-md1 simpleCart_shelfItem">
                                    <a href='<%# string.Format("productdetailssimple.aspx?{0}", Eval("ItemId")) %>'>
