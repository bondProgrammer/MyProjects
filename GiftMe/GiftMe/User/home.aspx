	      		...
	      		<ul class="rslides" id="slider">
	        		<li>
						...
						<div class="tes animated wow fadeInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
							...
							<p>IDEAL WAY TO BE ON THEIR MIND</p>
						</div>
	       			 </li>	
	      		</ul>
	 	 	</div>
		...
		<div class="content-top">
			<div class="content-top1">
				<div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="#">Printed Shirts</a></h3>
						<div class="price">
								<a href="#" class="item_add">Contact Now</a>
								<div class="clearfix"> </div>
						</div>
					</div>
				</div>	
			...
			<div class="content-top1">
				<div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="#">Personalised Keyring</a></h3>
						<div class="price">
								<a href="#" class="item_add">Contact Now</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="#">Personalised Card</a></h3>
						<div class="price">
								<a href="#" class="item_add">Contact Now</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-3 col-md2 animated wow fadeInRight" data-wow-delay=".5s">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="#">Personalised Photo Frames</a></h3>
						<div class="price">
								<a href="#" class="item_add">Contact Now</a>
								<div class="clearfix"> </div>
						</div>
			...
			<div class="col-md-3 col-md2 cmn animated wow fadeInRight" data-wow-delay=".5s">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="#">Personalized Cushion Gift</a></h3>
						<div class="price">
								<a href="#" class="item_add">Contact Now</a>
								<div class="clearfix"> </div>
						</div>
